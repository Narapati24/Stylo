    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="total">
                <td></td>
                <td>
                    Subtotal: Rp {{ number_format($transaction->total_price - $transaction->shipping_price, 0, ',', '.') }}<br>
                    Shipping: Rp {{ number_format($transaction->shipping_price, 0, ',', '.') }}<br>
